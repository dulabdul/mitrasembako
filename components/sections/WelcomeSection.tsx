...
export default function WelcomeSection() {
  // Teks sesuai referensi image_3.png
  const content = {
    topHeadline: 'Selamat Datang di Website',
    topSubheadline: 'Mulai Belanja Sembako Sekarang!',
    bannerHeadline:
      'Grosir Sembako Termurah & Terlengkap, Siap Kirim ke Seluruh Indonesia!',
    bannerBody:
      'Dapatkan harga grosir terbaik untuk gula pasir, minyak goreng, beras, mie instan, teh, kopi, LPG, dan berbagai kebutuhan sembako lainnya. Pesan mudah, stok selalu ready, dan pengiriman cepat.',
  };
        ...
        <Container>
          <div className='max-w-4xl'>
            ...
            <p className='text-xl md:text-2xl text-gray-900 mb-8 font-medium'>
              {content.topSubheadline}
            </p>

            <Button
              href={`https://wa.me/${SITE_CONFIG.whatsapp}`}
              target='_blank'
              variant='whatsapp' // Menggunakan varian WA yang sudah ada (Hijau)
              size='lg'>
              <svg
                fill='#fff'
                viewBox='0 0 32 32'
      ...
      <div className='bg-black/70 py-16 md:py-24'>
        <Container>
          <div className='max-w-4xl'>
            ...
            {/* Garis Garis Bawah Pendek */}
            <div className='h-1.5 w-24 bg-white mb-8'></div>
